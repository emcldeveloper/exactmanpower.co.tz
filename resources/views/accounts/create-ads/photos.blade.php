...
<div class="bg-white p-4 ">
    <div class="text-center py-4">
        <h4>UPLOADS YOUR AD PHOTOS</h4>
        <h5 class="text-light ">*File size should be below 10MB per file (Max image 10) </h5>
        <h5 class="text-light ">*File types allowed are .jpg .jpeg, .png </h5>
    </div>
...
<script type="text/x-handlebars-template" id="files-template">
    <div class="col-3 px-2 mb-3" id="media-@{{id}}">
        <div class="bg-white border">
            ...
            <div class="bg-light p-2">
                <div class="btn-group btn-group-sm">
                    <!-- <a class="btn py-0 px-2" href="{{ url('account/action/delete-media') }}?filename=@{{new_filename}}" ><i class="fa fa-sync"></i></a> -->
