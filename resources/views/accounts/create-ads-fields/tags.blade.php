...
<div class="form-group">
    ...
    <div class="input-group">
        ...
        @endif
        <textarea type="text" class="form-control tags-input {{ $errors->has('elements.'.$row->category_element_id)? 'is-invalid': null }}" name="elements[{{ $row->category_element_id }}]" placeholder="{{ $row->title }}" id="elements[{{ $row->category_element_id }}]">{{ $old_value }}</textarea>
    </div>
