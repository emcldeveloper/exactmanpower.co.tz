    ...
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                ...
                <span>Edit tag type ( {{ $model->name }} )</span>
            </div>
            <div>
                ...
                <a href="{{ url('admin/settings/tag-types/delete/'. $model->id) }}?redirect={{ url('admin/settings/tag-types/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model->name }}"?'><i class="fas fa-trash mr-1"></i> Delete</a>
            </div>
        </div>
    </div>
    <div class="container-detail bg-white">
        <div class="p-3">
            {!! \App\Handlers\Admin\Setting\TagType\EditFormHandler::handler(request(), new \App\Models\TagType(), $model->id) !!}
        </div>
    </div>
</div>
