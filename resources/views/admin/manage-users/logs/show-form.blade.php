...
<div class="clearfix p-3">
    ...
    <div class="card card-body col-12 col-md-10 m-auto">
            ...
            <div class="form-group form-row form-view mx-0">
                ...
                <div class="py-2 col">{{ ($model_info->url)? $model_info->url: '-' }}</div>
            </div>
            <!----- End form field url ----->
        
            <!----- Link to the edit page ----->
            <a class="btn btn-outline-dark mt-4" href="{{ url('admin/manage-users/logs/show/'.$model_info->log_id.'/edit') }}"><i class="fas fa-pencil-alt mr-1"></i> Edit</a>
    </div>
</div>