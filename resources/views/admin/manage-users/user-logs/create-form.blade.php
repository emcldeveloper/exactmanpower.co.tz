...
<form action="{{ url('admin/manage-users/user-logs/store'.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('account_id')? 'is-invalid': null }}" name="account_id" value="{{ old('account_id') }}" placeholder="Account" id="_input_account_id">
        ...
        @if(!isset($hidden) || (is_array($hidden) && !in_array("user_id", $hidden)))
        <div class="form-group">
        ...
        @if(!isset($hidden) || (is_array($hidden) && !in_array("log_id", $hidden)))
        <div class="form-group">
