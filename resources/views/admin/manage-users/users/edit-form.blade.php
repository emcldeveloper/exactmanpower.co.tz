...
<form action="{{ url('admin/manage-users/users/update/'.$model_info->user_id.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('social_name')? 'is-invalid': null }}" name="social_name" value="{{ $model_info->social_name }}" placeholder="Social Name" id="_input_social_name">
            <div class="invalid-feedback" id="_help_input_social_name">{{ $errors->has('social_name')? $errors->first('social_name'): null }}</div>
        </div>
        <!----- End form field social_name ----->
        <!----- Start form field social_id ----->
        <div class="form-group">
            <label class="mb-1" for="social_id">Social</label>
            <input type="text" class="form-control {{ $errors->has('social_id')? 'is-invalid': null }}" name="social_id" value="{{ $model_info->social_id }}" placeholder="Social" id="_input_social_id">
            <div class="invalid-feedback" id="_help_input_social_id">{{ $errors->has('social_id')? $errors->first('social_id'): null }}</div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control {{ $errors->has('password_confirmation')? 'is-invalid': null }}" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Password confirmation" id="_input_password_confirmation">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('email_verified_at')? 'is-invalid': null }}" name="email_verified_at" value="{{ $model_info->email_verified_at }}" placeholder="Email Verified Time" id="_input_email_verified_at">
            <div class="invalid-feedback" id="_help_input_email_verified_at">{{ $errors->has('email_verified_at')? $errors->first('email_verified_at'): null }}</div>
        </div>
...
window.form_children_input_value['insert_item_manage_users_users_user_logs_list'] = {!! old('manage_users_users_user_logs')? json_encode(old('manage_users_users_user_logs')): json_encode($model_info->user_logs) !!};
...
window.form_children_input_template['insert_item_manage_users_users_user_logs_list'] = function(i, random_id, data, error){ 
    ...
    var str = `
        <td>
            <input type="text" class="form-control ${ ((error && error.account_id)? 'is-invalid': '') }" name="user_logs_list[${random_id}][account_id]" value="${ ((data.account_id)? data.account_id:'') }" id="_input_account_id_${random_id}" placeholder="Account">
        </td>
        <td>
        ...
        <td>
            <input type="text" class="form-control ${ ((error && error.datail)? 'is-invalid': '') }" name="user_logs_list[${random_id}][datail]" value="${ ((data.datail)? data.datail:'') }" id="_input_datail_${random_id}" placeholder="Datail">
        </td>
        <td>
            <input type="text" class="form-control ${ ((error && error.timestamp)? 'is-invalid': '') }" name="user_logs_list[${random_id}][timestamp]" value="${ ((data.timestamp)? data.timestamp:'') }" id="_input_timestamp_${random_id}" placeholder="Timestamp">
        </td>
