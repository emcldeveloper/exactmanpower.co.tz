            ...
            <table class="table table-hover table-sm mb-0">
                ...
                @foreach ($sub_page_list as $index => $row)
                    <tr>
                        ...
                        <td>
                            <a class="d-block" href="{{ url('admin/posts/posts/show/'. $row->id) }}"><?= $row->post_title;?></a>
                        </td>
                        <td>
                            <span class="d-block">{{ $row->post_slug }}</span>
                        </td>
                        ...
                        <td>
                            <span class="d-block">{{ $row->post_date }}</span>
                        </td>
                        <td class="text-right">
                            <div class="btn-group btn-group-sm">
                                <a href="{{ url('admin/posts/posts/show/'. $row->id) }}" class="btn px-1 py-0"> <i class="fas fa-file"></i> </a>
                                <a href="{{ url('admin/posts/posts/edit/'. $row->id) }}" class="btn px-1 py-0"> <i class="fas fa-pencil-alt"></i> </a>
                                <a href="{{ url('admin/posts/posts/delete/'. $row->id) }}?redirect={{ url()->full() }}" class="btn px-1 py-0 text-danger" data-confirmation='I you sure, you want to delete "{{ $row->post_title }}"?'> <i class="fas fa-trash"></i> </a>
                            </div>
                        </td>
                    </tr>
                @endforeach
