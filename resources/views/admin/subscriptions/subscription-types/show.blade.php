...
<div class="main-container-middle">
    <div class="container-sidebar bg-white border-left border-right">
        <div class="main-container-middle">
            <div class="container-summary-sidebar border-bottom d-flex p-3">
                <div class="d-block">
                    <div class="h5 mb-3">
                    <!-- <a href="{{ url('admin/subscriptions/subscription-types/list') }}" class="btn btn-outline-primary mr-3" title="Back to subscription types list"><i class="fas fa-arrow-left"></i></a> -->
                    ...
                    <div class="container-detail" scroll-container>
                        <div class="clearfix">
                            ...
                            <div class="border-bottom p-2">
                                <a href="{{ url('admin/subscriptions/subscription-types/show/'.$row->id.( request('sub_page')? '/'.request('sub_page'): '' )) }}">{{ $row->name }}</a>
    ...
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                <span>Subscription Type info ( {{ $model_info->name }} )</span>
            </div>
            
            <div>
                <!-- <a href="{{ url('admin/subscriptions/subscription-types/edit/'.$model_info->id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> Edit</a> -->
                <a href="{{ url('admin/subscriptions/subscription-types/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i> Add Subscription Type</a>
                <!-- <a href="{{ url('admin/subscriptions/subscription-types/delete/'. $model_info->id) }}?redirect={{ url('admin/subscriptions/subscription-types/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model_info->name }}"?'><i class="fas fa-trash mr-1"></i> Delete</a> -->
                <div class="d-inline-block dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" id="dropdown-add-another">
                        <div class="dropdown-item" data-toggle="modal" data-target="#model_new_subscribers" >Add subscriber</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-navbar bg-white border-bottom" style="overflow:visible;">
        <nav class="nav">
            ...
            <a class="nav-link h-100 {{ Request::is('admin/subscriptions/subscription-types/show/'.$model_info->id)? 'active': null }}" href="{{ url('admin/subscriptions/subscription-types/show/' . $model_info->id) }}">Information</a>
            <a class="nav-link {{ Request::is('admin/subscriptions/subscription-types/show/*/subscribers')? 'active': null }}" href="{{ url('admin/subscriptions/subscription-types/show/' . $model_info->id . '/subscribers') }}">Subscribers</a>
        </nav>
    </div>
    <div class="container-detail bg-white">
        <div class="clearfix">
            {!! \App\Handlers\Admin\Subscription\SubscriptionType\ShowFormHandler::handler(request(), new \App\Models\SubscriptionType(), $model_info->id) !!}
        </div>
    </div>
</div>
<!-- Modal -->
<div class="modal fade" id="model_new_subscribers" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="background:rgba(0,0,0,.2);">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border:4px solid #1193d7;">
            ...
            <div class="modal-body">
                <div class="clearfix">
                {!! \App\Handlers\Admin\Subscription\Subscriber\CreateFormHandler::handler(request(), url()->full(), ['subscription_type_id'=>$model_info->id]) !!}
                </div>
            </div>
        </div>
    </div>
