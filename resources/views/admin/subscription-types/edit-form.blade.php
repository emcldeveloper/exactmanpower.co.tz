...
<form action="{{ url('admin/subscription-types/update/'.$model_info->subscription_type_id.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
