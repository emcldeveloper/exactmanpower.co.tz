...
<div class="main-container-middle">
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                ...
                <span>Edit subscription type ( {{ $model_info->name }} )</span>
            </div>
            <div>
                <a href="{{ url('admin/subscription-types/create') }}" class="btn btn-primary"><i class="fas fa-plus-circle mr-1"></i> Add new</a>
                <!-- <a href="{{ url('admin/subscription-types/list') }}" class="btn btn-primary"><i class="fas fa-list mr-1"></i> List</a> -->
    ...
    <div class="container-detail bg-white">
        <div class="p-3">
            {!! \App\Handlers\Admin\SubscriptionType\EditFormHandler::handler(request(), $model_info->subscription_type_id, false) !!}
        </div>
    </div>
</div>
