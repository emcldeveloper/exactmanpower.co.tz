...
<div class="main-container-middle">
    <div class="container-sidebar bg-white border-left border-right">
        <div class="main-container-middle">
            <div class="container-summary-sidebar border-bottom d-flex p-3">
                <div class="d-block">
                    <div class="h5 mb-1">
                    <!-- <a href="{{ url('admin/subscription-types/list') }}" class="btn btn-outline-primary mr-3" title="Back to subscription types list"><i class="fas fa-arrow-left"></i></a> -->
                    ...
                    <div class="container-detail" scroll-container>
                        <div class="clearfix custom-list-group">
                            ...
                            <div class="border-bottom custom-list-item p-2">
                                <a href="{{ url('admin/subscription-types/show/'.$row->subscription_type_id.( request('sub_page')? '/'.request('sub_page'): '' )) }}">{{ $row->name }}</a>
    ...
    <div class="container-header bg-white" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            ...
            <div>
                @if(false)
                <!-- <a href="{{ url('admin/subscription-types/edit/'.$model_info->subscription_type_id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> Edit</a> -->
                <a href="{{ url('admin/subscription-types/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i> Add Subscription Type</a>
                <!-- <a href="{{ url('admin/subscription-types/delete/'. $model_info->subscription_type_id) }}?redirect={{ url('admin/subscription-types/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model_info->name }}"?'><i class="fas fa-trash mr-1"></i> Delete</a> -->
    ...
    <div class="container-navbar bg-white border-bottom" style="overflow:visible;">
        <nav class="nav">
            ...
            <a class="nav-link {{ Request::is('admin/subscription-types/show/'.$model_info->subscription_type_id)? 'active': null }}" href="{{ url('admin/subscription-types/show/' . $model_info->subscription_type_id) }}">Information</a>
            <a class="nav-link {{ Request::is('admin/subscription-types/show/*/subscribers')? 'active': null }}" href="{{ url('admin/subscription-types/show/' . $model_info->subscription_type_id . '/subscribers') }}">Subscribers</a>
        </nav>
    </div>
    <div class="container-detail">
        <div class="clearfix">
            {!! \App\Handlers\Admin\SubscriptionType\ShowFormHandler::handler(request(), $model_info->subscription_type_id) !!}
        </div>
    </div>
</div>
