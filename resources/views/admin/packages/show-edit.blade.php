...
<form class="clearfix p-3" action="{{ url('admin/manage-ads/packages/update/'.$model_info->id.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    <div class="clearfix">
    {{ csrf_field() }}
