...
<div class="main-container-middle">
    <div class="container-sidebar bg-white border-left border-right">
        <div class="main-container-middle">
            <div class="container-summary-sidebar border-bottom d-flex p-3">
                <div class="d-block">
                    <div class="h5 mb-3">
                    <!-- <a href="{{ url('admin/manage-ads/packages/list') }}" class="btn btn-outline-primary mr-3" title="Back to packages list"><i class="fas fa-arrow-left"></i></a> -->
                    <span>Packages</span>
                    </div>
                    ...
                    <div class="container-detail" scroll-container>
                        <div class="clearfix">
                            ...
                            <div class="border-bottom p-2">
                                <a href="{{ url('admin/manage-ads/packages/show/'.$row->id.( request('sub_page')? '/'.request('sub_page'): '' )) }}">{{ $row->name }}</a>
    ...
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                <span>Package info ( {{ $model_info->name }} )</span>
            </div>
            
            <div>
                <!-- <a href="{{ url('admin/manage-ads/packages/edit/'.$model_info->id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> Edit</a> -->
                <a href="{{ url('admin/manage-ads/packages/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i> Add Package</a>
                <!-- <a href="{{ url('admin/manage-ads/packages/delete/'. $model_info->id) }}?redirect={{ url('admin/manage-ads/packages/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model_info->name }}"?'><i class="fas fa-trash mr-1"></i> Delete</a> -->
    ...
    <div class="container-navbar bg-white border-bottom" style="overflow:visible;">
        <nav class="nav">
            <a class="nav-link h-100 {{ Request::is('admin/manage-ads/packages/show/'.$model_info->id)? 'active': null }}" href="{{ url('admin/manage-ads/packages/show/' . $model_info->id) }}">Information</a>
            <a class="nav-link {{ Request::is('admin/manage-ads/packages/show/*/posts')? 'active': null }}" href="{{ url('admin/manage-ads/packages/show/' . $model_info->id . '/posts') }}">Posts</a>
        </nav>
    </div>
    <div class="container-detail bg-white">
        <div class="clearfix">
            {!! \App\Handlers\Admin\Package\ShowFormHandler::handler(request(), new \App\Models\Package(), $model_info->id) !!}
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border:4px solid #1193d7;">
            ...
            <div class="modal-body">
                <div class="clearfix">
                {!! \App\Handlers\Admin\ManagePost\Post\CreateFormHandler::handler(request(), url()->full(), ['package_id'=>$model_info->id]) !!}
                </div>
            </div>
        </div>
    </div>
