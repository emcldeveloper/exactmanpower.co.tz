...
<div class="main-container-middle">
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                <a href="{{ url($route_list) }}" class="btn btn-outline-primary mr-3" title="Back to posts list"><i class="fas fa-arrow-left"></i></a>
                <span>Create {{ $title }}</span>
            </div>
            <div>
                <!-- <a href="{{ url($route_list) }}" class="btn btn-primary"><i class="fas fa-list mr-1"></i> List</a> -->
            </div>
        </div>
    </div>
    <div class="container-detail bg-white">
        <div class="p-3">
            @include('admin/manage-posts/posts/create-form')
        </div>
    </div>
</div>
...
<!-- Modal -->
<div class="modal fade" id="model_new_input_package_id" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="background:rgba(0,0,0,.2);">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-border">
            <div class="modal-header bg-white text-primary py-2">
                <h5 class="modal-title">New Packages</h5>
                <button type="button" class="close py-1 my-0" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="clearfix">
                    {!! \App\Handlers\Admin\Package\CreateFormHandler::handler(request(), null) !!}
                </div>
            </div>
        </div>
    </div>
