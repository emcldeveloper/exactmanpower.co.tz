    ...
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                ...
                <span>Edit {{ $title }} ( {{ $model_info->post_title }} )</span>
            </div>
            <div>
                <a href="{{ url($route_base . 'create') }}" class="btn btn-primary"><i class="fas fa-plus-circle mr-1"></i> Add new</a>
                <!-- <a href="{{ url($route_base . 'list') }}" class="btn btn-primary"><i class="fas fa-list mr-1"></i> List</a> -->
                <a href="{{ url($route_base . 'delete/'. $model_info->id) }}?redirect={{ url($route . '/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model_info->post_title }}"?'><i class="fas fa-trash mr-1"></i> Delete</a>
            </div>
        </div>
    </div>
    <div class="container-detail bg-white">
        <div class="p-3">
            @include('admin/manage-posts/posts/edit-form')
        </div>
    </div>
</div>
