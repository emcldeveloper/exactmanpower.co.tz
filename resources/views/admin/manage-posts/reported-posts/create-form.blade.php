...
<form action="{{ url('admin/manage-posts/reported-posts/store'.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST">
    {{ csrf_field() }}
    ...
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('reported_by')? 'is-invalid': null }}" name="reported_by" value="{{ old('reported_by') }}" placeholder="Reported By" id="_input_reported_by">
            <div class="invalid-feedback" id="_input_help_reported_by">{{ $errors->has('reported_by')? $errors->first('reported_by'): null }}</div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control datepicker {{ $errors->has('reported_time')? 'is-invalid': null }}" name="reported_time" value="{{ old('reported_time') }}" placeholder="Reported Time" id="_input_reported_time">
            <div class="invalid-feedback" id="_input_help_reported_time">{{ $errors->has('reported_time')? $errors->first('reported_time'): null }}</div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="custom-control custom-switch {{ $errors->has('is_cleared')? 'is-invalid': null }}">
                <input type="checkbox" class="custom-control-input" id="is_cleared" name="is_cleared" id="_input_is_cleared" {{ old('is_cleared')? 'checked':null }}>
                <label class="custom-control-label" for="is_cleared">Please check if is cleared</label>
            </div>
            <div class="invalid-feedback" id="_input_help_is_cleared">{{ $errors->has('is_cleared')? $errors->first('is_cleared'): null }}</div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('cleared_by')? 'is-invalid': null }}" name="cleared_by" value="{{ old('cleared_by') }}" placeholder="Cleared By" id="_input_cleared_by">
            <div class="invalid-feedback" id="_input_help_cleared_by">{{ $errors->has('cleared_by')? $errors->first('cleared_by'): null }}</div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control datepicker {{ $errors->has('cleared_at')? 'is-invalid': null }}" name="cleared_at" value="{{ old('cleared_at') }}" placeholder="Cleared Time" id="_input_cleared_at">
            <div class="invalid-feedback" id="_input_help_cleared_at">{{ $errors->has('cleared_at')? $errors->first('cleared_at'): null }}</div>
        </div>
