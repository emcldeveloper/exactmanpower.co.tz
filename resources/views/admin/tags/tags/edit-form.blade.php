...
<form action="{{ url('admin/tags/tags/update/'.$model_info->tag_id.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
...
window.form_children_input_value['insert_item_tags_tags_post_tags_list'] = {!! old('tags_tags_post_tags')? json_encode(old('tags_tags_post_tags')): json_encode($model_info->post_tags) !!};
