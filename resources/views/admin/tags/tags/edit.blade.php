...
<div class="main-container-middle">
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                <a href="{{ url('admin/tags/tags/list') }}" class="btn btn-outline-primary mr-3" title="Back to tags list"><i class="fas fa-arrow-left"></i></a>
            ...
            <div>
                ...
                <!-- <a href="{{ url('admin/tags/tags/list') }}" class="btn btn-primary"><i class="fas fa-list mr-1"></i> List</a> -->
    ...
    <div class="container-detail bg-white">
        <div class="p-3">
            {!! \App\Handlers\Admin\Tag\Tag\EditFormHandler::handler(request(), $model_info->tag_id, false) !!}
        </div>
    </div>
</div>
