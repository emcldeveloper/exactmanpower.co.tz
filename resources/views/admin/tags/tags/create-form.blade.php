...
<form action="{{ url('admin/tags/tags/store'.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="clearfix">
        ...
        @if(!isset($hidden) || (is_array($hidden) && !in_array("tag_type_id", $hidden)))
        <div class="form-group">
        ...
        <div class="clearfix mb-3 post-tags-item-container" data-children="tags_tags_post_tags_list">
...
window.form_children_input_value['insert_item_tags_tags_post_tags_list'] = {!! old('tags_tags_post_tags')? json_encode(old('tags_tags_post_tags')): '[{}]' !!};
window.form_children_input_error['insert_item_tags_tags_post_tags_list'] = {!! ($errors->get('tags_tags_post_tags.*')? json_encode($errors->get('tags_tags_post_tags.*')): 'null') !!};
window.form_children_input_template['insert_item_tags_tags_post_tags_list'] = function(i, random_id, data, error){ 
    if(!random_id) {
