...
<form action="{{ url('admin/posts/'.request('post_type_id').'/store'.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="clearfix">
        ...
        <div class="row">
            <div class="col-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('post_title')? 'is-invalid': null }}" name="post_title" value="{{ old('post_title') }}" placeholder="Post Title" id="_input_post_title">
        ...
        <div class="form-group">
            ...
            <textarea name="post_content" class="form-control ckeditor {{ $errors->has('post_content')? 'is-invalid': null }}" placeholder="Post Content" rows="4" id="_input_post_content">{{ old('post_content') }}</textarea>
        ...
        <div class="row">
            ...
            <div class="col">
                <!----- Start form field post_featured_icon ----->
                <div class="form-group">
                    <label class="mb-1" for="post_featured_icon">Post Featured Icon</label>
                    <div class="custom-file">
                        <input name="post_featured_icon" type="file" class="custom-file-input"  id="_input_post_featured_icon">
                        <label class="custom-file-label" for="_input_post_featured_icon">Choose file</label>
                    </div>
                    <div class="invalid-feedback" id="_input_help_post_featured_icon">{{ $errors->has('post_featured_icon')? $errors->first('post_featured_icon'): null }}</div>
                </div>
                <!----- End form field post_featured_icon ----->
            </div>
        </div>
