<div class="px-3 pb-3">
        ...
        <div class="row align-items-center justify-content-between m-0">
            ...
            <div class="col-12 col-md-12 p-0 mb-3 mb-md-0" style="margin-top: 1%;">
                <div class="row">
    ...
    <div class="px-3">
        ...
        <div class="card zoom hover-container box-shadow rounded-0 py-2 px-4 mb-2">
            <div class="row align-items-center">
                <div class="col pr-0" style="max-width:50px;">{{ ($posts_list->firstItem() + $index) }}</div>
                
                <div class="col pr-0">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-4">
                            <a href="{{ url('admin/posts/'.request('post_type_id').'/show/'.$row->post_id) }}" class="media align-items-center">
                                    ...
                                    <span class="d-block">
                                        ...
                                        @else
                                            <a class="btn btn-primary" style="border-radius: 20px;">
                                                {{Illuminate\Support\Str::limit('Unpublished',8)}}
                                            </a>
                                        @endif
                                    </span>
                                </div>
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <span class="d-block">{!!  date('d M Y', strtotime($row->updated_at)) !!} </span>
                                </div>
                                <div class="col">
                                    <span class="d-block"></span>
                                </div>
                ...
                <div class="col text-right" style="max-width:190px;">
                    <div class="btn-group btn-group-sm">
                        ...
                        <a href="{{ url('admin/posts/'.request('post_type_id').'/show/' . $row->post_id . '/post-comments') }}" class="btn btn-outline-dark btn-circle  px-2 mr-2"> <i class="fas fa-comments fa-sm"></i> {{$row->post_comments()->count()}} </a>
                        <a data-toggle="collapse" href="#collapse-more2-{{ $row->post_id }}" class="btn btn-link text-dark mr-1" title="More"> <i class="fas fa-ellipsis-v fa-sm"></i> </a>
                    </div>
                </div>
            </div>


            <div class="collapse" id="collapse-more2-{{ $row->post_id }}">
        ...
        <div class="border bg-white">
            <table class="table table-hover table-sm mb-0">
                ...
                @foreach ($posts_list as $index => $row)
                    <tr>
                        <td scope="row">{{ ($posts_list->firstItem() + $index) }}</td>
                        <td>
