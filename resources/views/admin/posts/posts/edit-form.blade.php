...
<form action="{{ url('admin/posts/posts/update/'.$model_info->post_id.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="clearfix">
        <div class="row">
            <div class="col-8">
                ...
                <div class="form-group">
                    <label class="mb-1" for="post_title">
                        ...
                        <div class="invalid-feedback" id="_help_input_post_title">
                            {{ $errors->has('post_title')? $errors->first('post_title'): null }}
                        </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('post_team_position')? 'is-invalid': null }}" name="post_team_position" value="{{ $model_info->post_team_position }}" placeholder="Staff Position" id="_input_post_team_position">
        ...
        <div class="form-group">
            ...
            <input name="post_content" value="{{ $model_info->post_content }}" class="form-control  {{ $errors->has('post_content')? 'is-invalid': null }}" placeholder="Post Content" rows="4" id="_input_post_content"/>
            <div class="invalid-feedback" id="_help_input_post_content">
                {{ $errors->has('post_content')? $errors->first('post_content'): null }}
            </div>
            @else
            ...
            <div class="col-8">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-date">
                        <input name="btn_name" value="{{$model_info->btn_name}}" type="text" class="form-control"  id="btn_name" required>
                    ...
                    <div class="custom-date">
                        <input name="event_date" value="{{$model_info->event_date}}" type="date" class="form-control"  id="event_date" required="required">
