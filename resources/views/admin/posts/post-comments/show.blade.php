...
<div class="main-container-middle">
    <div class="container-sidebar bg-white border-left border-right">
        <div class="main-container-middle">
            <div class="container-summary-sidebar border-bottom d-flex p-3">
                <div class="d-block">
                    <div class="h5 mb-1">
                    <!-- <a href="{{ url('admin/posts/post-comments/list') }}" class="btn btn-outline-primary mr-3" title="Back to post comments list"><i class="fas fa-arrow-left"></i></a> -->
                    ...
                    <div class="container-detail" scroll-container>
                        <div class="clearfix custom-list-group">
                            ...
                            <div class="border-bottom custom-list-item p-2">
                                <a href="{{ url('admin/posts/post-comments/show/'.$row->post_comment_id.( request('sub_page')? '/'.request('sub_page'): '' )) }}">{{ $row->post_id }}</a>
    ...
    <div class="container-header bg-white" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                <span>Post Comment info ( {{ $model_info->post_id }} )</span>
            </div>
            
            <div>
                @if(false)
                <!-- <a href="{{ url('admin/posts/post-comments/edit/'.$model_info->post_comment_id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> Edit</a> -->
                <a href="{{ url('admin/posts/post-comments/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i> Add Post Comment</a>
                <!-- <a href="{{ url('admin/posts/post-comments/delete/'. $model_info->post_comment_id) }}?redirect={{ url('admin/posts/post-comments/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model_info->post_id }}"?'><i class="fas fa-trash mr-1"></i> Delete</a> -->
    ...
    <div class="container-navbar bg-white border-bottom" style="overflow:visible;">
        <nav class="nav">
            ...
            <a class="nav-link {{ Request::is('admin/posts/post-comments/show/'.$model_info->post_comment_id)? 'active': null }}" href="{{ url('admin/posts/post-comments/show/' . $model_info->post_comment_id) }}">Information</a>
            <a class="nav-link {{ Request::is('admin/posts/post-comments/show/*/post-comments')? 'active': null }}" href="{{ url('admin/posts/post-comments/show/' . $model_info->post_comment_id . '/post-comments') }}">Post Comments</a>
        </nav>
    </div>
    <div class="container-detail">
        <div class="clearfix">
            {!! \App\Handlers\Admin\Post\PostComment\ShowFormHandler::handler(request(), $model_info->post_comment_id) !!}
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border:4px solid #1193d7;">
            ...
            <div class="modal-body">
                <div class="clearfix">
                {!! \App\Handlers\Admin\Post\PostComment\CreateFormHandler::handler(request(), false, url()->full(), ['parent_post_comment_id'=>$model_info->post_comment_id]) !!}
                </div>
            </div>
        </div>
    </div>
