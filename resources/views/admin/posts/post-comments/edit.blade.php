...
<div class="main-container-middle">
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                ...
                <span>Edit post comment ( {{ $model_info->post_id }} )</span>
            </div>
            <div>
                <a href="{{ url('admin/posts/post-comments/create') }}" class="btn btn-primary"><i class="fas fa-plus-circle mr-1"></i> Add new</a>
                <!-- <a href="{{ url('admin/posts/post-comments/list') }}" class="btn btn-primary"><i class="fas fa-list mr-1"></i> List</a> -->
    ...
    <div class="container-detail bg-white">
        <div class="p-3">
            {!! \App\Handlers\Admin\Post\PostComment\EditFormHandler::handler(request(), $model_info->post_comment_id, false) !!}
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border:4px solid #1193d7;">
            ...
            <div class="modal-body">
                <div class="clearfix">
                    {!! \App\Handlers\Admin\Post\Post\CreateFormHandler::handler(request(), null) !!}
                </div>
            </div>
        </div>
    </div>
