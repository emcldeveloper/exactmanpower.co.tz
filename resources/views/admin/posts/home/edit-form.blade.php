...
<form action="{{route('slider-store')}}" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" name="post_status" value="{{$slider->post_status}}">
    ...
    <div class="clearfix">
        ...
        <div class="row">
            <div class="col-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('post_title')? 'is-invalid': null }}" name="post_title" value="{{ $slider->post_title }}" placeholder="Post Title" id="_input_post_title">
            ...
            <div class="form-group">
                    <label class="mb-1" for="post_type_id">Post Type</label>
                     <select class="form-control {{ $errors->has('post_type_id')? 'is-invalid': null }}" name="post_type_id" id="_input_post_type_id">
                        ...
                        {{-- @foreach(\App\Models\PostType::all() as $row) --}}
                        <option value=" {{ $slider->post_type_id }}">{{ $slider->post_type_id }}</option>
                        {{-- @endforeach  --}}                  
                    </select> 
        ...
        <div class="form-group">
            <label class="mb-1" for="post_content">sub-title</label>

            <input type="text" class="form-control {{ $errors->has('post_title')? 'is-invalid': null }}" name="sub_title" value="{{ $slider->post_content }}" placeholder="Post Title" id="_input_post_title">
...
{{--        <div class="form-group">
            <label class="mb-1" for="event_date">Post Event Date</label>
            <div class="custom-date">
                <input name="event_date" value="{{$slider->event_date}}" type="date" class="form-control"  id="event_date" required>
