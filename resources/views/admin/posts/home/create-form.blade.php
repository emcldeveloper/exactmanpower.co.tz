...
<form action="{{route('slider-store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('post_title')? 'is-invalid': null }}" name="sub_title" value="{{ old('post_title') }}" placeholder="Post Title" id="_input_post_title">
