...
<div class="main-container-middle">
    <div class="container-sidebar bg-white border-left border-right">
        <div class="main-container-middle">
            <div class="container-summary-sidebar border-bottom d-flex p-3">
                <div class="d-block">
                    <div class="h5 mb-3">
                    <!-- <a href="{{ url('admin/logs/logs/list') }}" class="btn btn-outline-primary mr-3" title="Back to logs list"><i class="fas fa-arrow-left"></i></a> -->
                    <span>Logs</span>
                    </div>
                    ...
                    <div class="container-detail" scroll-container>
                        <div class="clearfix">
                            ...
                            <div class="border-bottom p-2">
                                <a href="{{ url('admin/logs/logs/show/'.$row->id.( request('sub_page')? '/'.request('sub_page'): '' )) }}">{{ $row->name }}</a>
    ...
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                <span>Log info ( {{ $model_info->name }} )</span>
            </div>
            
            <div>
                <!-- <a href="{{ url('admin/logs/logs/edit/'.$model_info->id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> Edit</a> -->
                <a href="{{ url('admin/logs/logs/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i> Add Log</a>
                <!-- <a href="{{ url('admin/logs/logs/delete/'. $model_info->id) }}?redirect={{ url('admin/logs/logs/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model_info->name }}"?'><i class="fas fa-trash mr-1"></i> Delete</a> -->
    ...
    <div class="container-navbar bg-white border-bottom" style="overflow:visible;">
        <nav class="nav">
            ...
            <a class="nav-link h-100 {{ Request::is('admin/logs/logs/show/'.$model_info->id)? 'active': null }}" href="{{ url('admin/logs/logs/show/' . $model_info->id) }}">Information</a>
            <a class="nav-link {{ Request::is('admin/logs/logs/show/*/user-logs')? 'active': null }}" href="{{ url('admin/logs/logs/show/' . $model_info->id . '/user-logs') }}">User Logs</a>
        </nav>
    </div>
    <div class="container-detail bg-white">
        <div class="clearfix">
            {!! \App\Handlers\Admin\Log\Log\ShowFormHandler::handler(request(), new \App\Models\Log(), $model_info->id) !!}
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border:4px solid #1193d7;">
            ...
            <div class="modal-body">
                <div class="clearfix">
                {!! \App\Handlers\Admin\ManageUser\UserLog\CreateFormHandler::handler(request(), url()->full(), ['log_id'=>$model_info->id]) !!}
                </div>
            </div>
        </div>
    </div>
