    ...
    <div class="container-header" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                ...
                <span>Edit category element ( {{ $model->name }} )</span>
            </div>
            <div>
                ...
                <!-- <a href="{{ url('admin/manage-categories/category-elements/list') }}" class="btn btn-primary"><i class="fas fa-list mr-1"></i> List</a> -->
                <a href="{{ url('admin/manage-categories/category-elements/delete/'. $model->id) }}?redirect={{ url('admin/manage-categories/category-elements/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model->name }}"?'><i class="fas fa-trash mr-1"></i> Delete</a>
            </div>
        </div>
    </div>
    <div class="container-detail bg-white">
        <div class="p-3">
            {!! \App\Handlers\Admin\ManageCategory\CategoryElement\EditFormHandler::handler(request(), new \App\Models\CategoryElement(), $model->id) !!}
        </div>
    </div>
</div>

<!-- Modal -->
<div class="modal fade" id="model_new_input_category_id" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="background:rgba(0,0,0,.2);">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border:4px solid #1193d7;">
            ...
            <div class="modal-body">
                <div class="clearfix">
                    {!! \App\Handlers\Admin\ManageCategory\Category\CreateFormHandler::handler(request(), null) !!}
                </div>
            </div>
        </div>
    </div>
