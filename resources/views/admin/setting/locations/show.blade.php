...
<div class="main-container-middle">
    <div class="container-sidebar bg-white border-left border-right">
        <div class="main-container-middle">
            <div class="container-summary-sidebar border-bottom d-flex p-3">
                <div class="d-block">
                    <div class="h5 mb-1">
                    <!-- <a href="{{ url('admin/setting/locations/list') }}" class="btn btn-outline-primary mr-3" title="Back to locations list"><i class="fas fa-arrow-left"></i></a> -->
                    <span>Locations</span>
                    </div>
                    ...
                    <div class="container-detail" scroll-container>
                        <div class="clearfix custom-list-group">
                            ...
                            <div class="border-bottom custom-list-item p-2">
                                <a href="{{ url('admin/setting/locations/show/'.$row->location_id.( request('sub_page')? '/'.request('sub_page'): '' )) }}">{{ $row->name }}</a>
    ...
    <div class="container-header bg-white" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            ...
            <div>
                @if(false)
                <!-- <a href="{{ url('admin/setting/locations/edit/'.$model_info->location_id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> Edit</a> -->
                <a href="{{ url('admin/setting/locations/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i> Add Location</a>
                <!-- <a href="{{ url('admin/setting/locations/delete/'. $model_info->location_id) }}?redirect={{ url('admin/setting/locations/list') }}" class="btn btn-danger" data-confirmation='I you sure, you want to delete "{{ $model_info->name }}"?'><i class="fas fa-trash mr-1"></i> Delete</a> -->
    ...
    <div class="container-navbar bg-white border-bottom" style="overflow:visible;">
        <nav class="nav">
            ...
            <a class="nav-link {{ Request::is('admin/setting/locations/show/'.$model_info->location_id)? 'active': null }}" href="{{ url('admin/setting/locations/show/' . $model_info->location_id) }}">Information</a>
            <a class="nav-link {{ Request::is('admin/setting/locations/show/*/posts')? 'active': null }}" href="{{ url('admin/setting/locations/show/' . $model_info->location_id . '/posts') }}">Posts</a>
        </nav>
    </div>
    <div class="container-detail">
        <div class="clearfix">
            {!! \App\Handlers\Admin\Setting\Location\ShowFormHandler::handler(request(), $model_info->location_id) !!}
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border:4px solid #1193d7;">
            ...
            <div class="modal-body">
                <div class="clearfix">
                {!! \App\Handlers\Admin\Post\Post\CreateFormHandler::handler(request(), false, url()->full(), ['location_id'=>$model_info->location_id]) !!}
                </div>
            </div>
        </div>
    </div>
