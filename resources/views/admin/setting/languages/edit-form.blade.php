...
<form action="{{ url('admin/setting/languages/update/'.$model_info->id.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST">
    {{ csrf_field() }}
    ...
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('locale')? 'is-invalid': null }}" name="locale" value="{{ $model_info->locale }}" placeholder="locale" id="_input_name">
