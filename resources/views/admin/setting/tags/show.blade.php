...
<div class="main-container-middle">
    <div class="container-header bg-white" style="overflow:visible;">
        <div class="row align-items-center justify-content-between p-3">
            <div class="col-12 col-md-6 mb-3 mb-md-0 h5 m-0">
                <a href="{{ url('admin/setting/tags/list') }}" class="btn btn-outline-primary px-2 mr-3" title="Back to tags list"><i class="fas fa-arrow-left"></i></a>
                <span>Tag info ( {{ $model_info->name }} )</span>
            </div>
            
            <div class="col-12 col-md-6 d-none d-md-block text-right">
                <!-- <a href="{{ url('admin/setting/tags/edit/' . $model_info->tag_id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> Edit</a> -->
                <a href="{{ url('admin/setting/tags/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i>Add Tag</a>
    ...
    <div class="container-detail">
        <div class="p-3">
            {!! \App\Handlers\Admin\Setting\Tag\ShowFormHandler::handler(request(), $model_info->tag_id) !!}
        </div>
    </div>
</div>
