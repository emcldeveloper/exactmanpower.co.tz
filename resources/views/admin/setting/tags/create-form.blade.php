...
<form action="{{ url('admin/setting/tags/store'.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
...
window.form_children_input_value['insert_item_setting_tags_post_tags_list'] = {!! old('setting_tags_post_tags')? json_encode(old('setting_tags_post_tags')): '[{}]' !!};
