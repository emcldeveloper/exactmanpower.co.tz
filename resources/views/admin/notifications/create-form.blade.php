...
<form action="{{ url('admin/notifications/store'.(isset($redirect)? '?redirect='.$redirect: null)) }}" method="POST">
    {{ csrf_field() }}
    ...
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <textarea name="content" class="form-control {{ $errors->has('content')? 'is-invalid': null }}" placeholder="Content" rows="4" id="_input_content">{{ old('content') }}</textarea>
            <div class="invalid-feedback" id="_input_help_content">{{ $errors->has('content')? $errors->first('content'): null }}</div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('link')? 'is-invalid': null }}" name="link" value="{{ old('link') }}" placeholder="Link" id="_input_link">
            <div class="invalid-feedback" id="_input_help_link">{{ $errors->has('link')? $errors->first('link'): null }}</div>
        </div>
        <!----- End form field link ----->
