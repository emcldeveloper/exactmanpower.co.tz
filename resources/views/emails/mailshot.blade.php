                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="http://project.co/exactonline"
                                ...
                                <img src="{{ asset('img/logo-color.svg') }}" alt="{{ config('app.name') }}" width="300px">
                            </a>
                        </td>
                    </tr>
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0"
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; margin-top: 25px;">
                                            <tr>
                                                <td
                                                    style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box;">
                                                    <img src="{{ asset('img/placeholder.png') }}" alt="" width="100%">
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td width="200px" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding-right:35px;">
                                                    <img src="{{ asset('img/placeholder.png') }}" alt="" width="100%">
                                                </td>
                                                <td style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box;">
                                                    <p style="font-weight:700;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3D4852; font-size: 16px; line-height: 1.5em; margin: 0; text-align: left;">
                                                        Smartphone Bay</p>
                                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3D4852; font-size: 16px; line-height: 1.5em; margin: 0; text-align: left;">
                                                        DAR ES SALAAM</p>
                                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3D4852; font-size: 16px; line-height: 1.5em; margin: 0; text-align: left;">
                                                        one month ago</p>
                                                </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">
                                            ...
                                            The Arcade, Mwai kibaki Rd, Mikocheni,  Dar Es Salaam.<br>
                                            To unsubscribe click: <a href="{{ url('') }}">here</a></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
