...
class ShowFormHandler
{
    ...
    public static function handler(Request $request, $location_id = null, $api = false, $redirect = null, $hidden = [])
    {
        ...
        if($sub_page == 'posts') {
            $data['sub_page_list'] = self::posts($request, $location_id);
        }

        if($sub_page === 'form' || $sub_page === 'edit') {
            $model_list = self::form($request, $location_id);

            $data['is_namespace'] = 'setting.';
        ...
        return view('admin.setting.locations.'.$sub_view, $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public static function form(Request $request, $location_id = null, $redirect = null, $hidden = [])
    {
        // initialize data to send to the view or client
        $data = [];
     ...
     * @return \Illuminate\Http\Response
     */
    public static function posts(Request $request, $location_id = null)
    {
        ...
        $model = Post::where('location_id', $location_id);
