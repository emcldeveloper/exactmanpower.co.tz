...
class ShowFormHandler
{
    ...
    public static function handler(Request $request, TagType $tag_types, $id = null, $redirect = null, $hidden = [])
    {
        ...
        if($sub_page === 'form' || $sub_page === 'edit') {
            $model_list = self::form($request, $tag_types, $id);
        ...
        return view('admin.settings.tag-types.'.$sub_view, $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public static function form(Request $request, TagType $tag_types, $id = null, $redirect = null, $hidden = [])
    {
        // initialize data to send to the view or client
        $data = [];
        ...
        // Get and assign child data from Tag model to $data
