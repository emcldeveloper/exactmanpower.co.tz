...
<div class="card border-0 p-4 mb-4 ">
    <div class="w-100 mx-auto">
        ...
        <form action="{{ url('permissions/groups/store') }}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="clearfix">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('description')? 'is-invalid': null }}" name="description" value="{{ old('description') }}" placeholder="Description" id="_input_description">
                ...
                <div class="form-group">
                    ...
                    @php   
                        $selected_permissions = is_array(old('permissions'))? old('permissions'): [];
                    @endphp
                    @foreach($permissions_list as $row)
                        <div class="col-6 custom-control custom-checkbox custom-control-inline">
