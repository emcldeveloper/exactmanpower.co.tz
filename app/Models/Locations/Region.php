...
class Region extends Model
{
	...
	{
		return $this->belongsTo('App\Models\Locations\Country', 'location_id', 'parent_location_id');
	}
    /**
     * Retrieve related data from locations using undefined value.
	...
	{
		return $this->hasMany('App\Models\Locations\District', 'parent_location_id', 'location_id');
	}
}
