...
class District extends Model
{
	...
	{
		return $this->belongsTo('App\Models\Locations\Region', 'location_id', 'parent_location_id');
	}
    /**
     * Retrieve related data from locations using undefined value.
	...
	{
		return $this->hasMany('App\Models\Locations\Ward', 'parent_location_id', 'location_id');
	}
}
